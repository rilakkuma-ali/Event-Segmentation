...
# Paste your path
setwd("C:/Projects/EventSegmentation/Encoding_Results")
...
files <- list.files(path="C:/Projects/EventSegmentation/Encoding_Results", pattern="*.txt", full.names=TRUE, recursive=FALSE)
...
write.csv(All_Data,"C:/Projects/EventSegmentation/Encoding_Results_All.csv", row.names = FALSE)
rm(list=ls())