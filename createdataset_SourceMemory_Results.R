...
files <- list.files(path="C:/Projects/EventSegmentation/SourceMemory_Results", pattern="*.txt", full.names=TRUE, recursive=FALSE)
...
write.csv(All_Data,"C:/Projects/EventSegmentation/SourceMemory_Results_All.csv", row.names = FALSE)
rm(list=ls())