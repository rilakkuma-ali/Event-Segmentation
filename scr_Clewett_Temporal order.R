...
AllData <- read.csv("C:/Projects/Event-Segmentation/data_Clewett/Clewett_temp_order_Exp3.csv", dec=",")
#=======Data for rmANOVA========================================================
...
t.test(subset(MyAllData2, MyAllData$Condition == "SameContext")$ratio,
       subset(MyAllData2, MyAllData$Condition == "Boundary")$ratio, 
       paired = T)
cohen_stats <- cohen.d(MyAllData2$ratio, MyAllData2$Condition)
cohen_stats
